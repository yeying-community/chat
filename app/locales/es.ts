...
const es: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    Return: "Regresar",
    TopTips:
      "🥳 Oferta de lanzamiento de Chat AI, desbloquea OpenAI o1, GPT-4o, Claude-3.5 y los últimos grandes modelos",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        SubTitle:
          "Officially maintained by Chat, zero configuration ready to use, supports the latest large models like OpenAI o1, GPT-4o, and Claude-3.5",
        ChatNow: "Chat Now",
      },
      ...
      Volcengine: {
        ApiKey: {
          Title: "Clave de interfaz",
          SubTitle: "Usa una clave API de volcengine personalizada",
          Placeholder: "Clave API de volcengine",
        },
        Endpoint: {
          Title: "Dirección del endpoint",
          SubTitle: "Ejemplo:",

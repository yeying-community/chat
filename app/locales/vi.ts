...
const vi: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Sử dụng Chat AI",
        Label: "(Giải pháp tiết kiệm chi phí nhất)",
        SubTitle:
          "Được Chat chính thức duy trì, sẵn sàng sử dụng mà không cần cấu hình, hỗ trợ các mô hình lớn mới nhất như OpenAI o1, GPT-4o và Claude-3.5",
        ChatNow: "Chat ngay",
      },

...
const fr: PartialLocaleType = {
 ...
 `,
  ...
  Auth: {
    ...
    Tips: "La vérification par mot de passe est activée. Veuillez entrer le code d'accès ci-dessous",
    ...
    Return: "Retour",
    TopTips:
      "🥳 Offre de lancement Chat AI, débloquez OpenAI o1, GPT-4o, Claude-3.5 et les derniers grands modèles",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Utiliser Chat AI",
        Label: "(La solution la plus rentable)",
        SubTitle:
          "Officiellement maintenu par Chat, prêt à l'emploi sans configuration, prend en charge les derniers grands modèles comme OpenAI o1, GPT-4o et Claude-3.5",
        ChatNow: "Discuter maintenant",
      },

      AccessCode: {
        Title: "Mot de passe d'accès",
        SubTitle: "L'accès sécurisé est activé",
      ...
      Volcengine: {
        ApiKey: {
          Title: "Clé d'interface",
          SubTitle: "Utiliser une clé API volcengine personnalisée",
          Placeholder: "Clé API volcengine",
        },
        Endpoint: {
          Title: "Adresse de l'interface",
          SubTitle: "Exemple :",

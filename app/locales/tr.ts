...
const tr: PartialLocaleType = {
 ...
 `,
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Chat AI kullanın",
        Label: "(En maliyet etkin çözüm)",
        SubTitle:
          "Chat tarafından resmi olarak yönetilmektedir, yapılandırma olmadan hemen kullanıma hazırdır, OpenAI o1, GPT-4o, Claude-3.5 gibi en son büyük modelleri destekler",
